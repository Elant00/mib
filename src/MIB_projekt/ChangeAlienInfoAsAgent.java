 ...
 * @author emilrydberg
 */
public class ChangeAlienInfoAsAgent extends javax.swing.JFrame {

    Validation validator = new Validation();
    /**
     * Creates new form ChangeAlienInfoAsAgent
     */
     ...
     * @param iidb
     */
    public ChangeAlienInfoAsAgent(InfDB iidb) {
        initComponents();
        idb = iidb;
    }
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChangeAlienInfoAsAgent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChangeAlienInfoAsAgent(idb).setVisible(true);
            }
        });
    }
